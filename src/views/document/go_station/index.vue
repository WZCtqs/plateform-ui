<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      <el-form-item label="班列编号" prop="classNum">
        <el-input
          v-model.trim="queryParams.classNum"
          placeholder="请输入班列编号"
          clearable
          size="small"
      ...
      <el-form-item>
        ...
        <el-button icon="el-icon-refresh" size="mini" @click="resetQuery">重置</el-button>
         ...
         <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['track:goStation:edit']"
        >修改</el-button>
    </el-form>
    <el-table v-loading="loading" :data="goStationList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="班列编号" align="center" prop="classNum" />
      <el-table-column label="班列日期" align="center" prop="classDate" />
      <el-table-column label="口岸" align="center" prop="port" />
      <el-table-column label="下货站" align="center" prop="downStation" />
      <el-table-column label="车站地址" align="center" prop="stationAddress" show-overflow-tooltip/>
    </el-table>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="车站地址" prop="stationAddress">
          <el-input v-model.trim="form.stationAddress" :rows="6" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
...
<script>
import { listGoStation, getGoStation, delGoStation, addGoStation, updateGoStation, importObj } from "@/api/document/go_station";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listGoStation(this.queryParams).then(response => {
