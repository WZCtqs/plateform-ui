    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['track:address:remove']"
        >删除</el-button>
      </el-col>
    </el-row>
...
<script>
import { listAddress, getAddress, delAddress, addAddress, updateAddress, exportAddress } from "@/api/document/address";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除运踪_位置地名管理--沿途运踪使用编号为"' + ids + '"的数据项?', "警告", {
