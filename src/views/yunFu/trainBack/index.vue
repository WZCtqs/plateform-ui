    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="运踪时间"
        ...
        <template slot-scope="scope">
          <span v-if="scope.row.isEdit=='0'"
                style="color:red">{{scope.row.distributionTime}}</span>
          <span v-if="scope.row.isEdit=='1'"
                style="color:#606266">{{scope.row.distributionTime}}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="titl"
      ...
      <table border="1">
        <tr>
          ...
          <td colspan='3'
              style="color:red;width:33%"> 站点和口岸的距离只识别数字、0、/;预计时间不确定不用填写</td>
        ...
        <tr>
          ...
          <template v-if="this.leixing=='0'">
            ...
            <td>
              <el-input v-model.trim="fo.stationFouName"
                        style="width:100%;"
                        disabled
                        placeholder="" />
            </td>
        ...
        <tr>
          ...
          <template v-if="this.leixing=='0'">
            ...
            <td>
              <el-input v-model.trim="fo.stationFouDistance"
                        style="width:100%;"
                        placeholder="" />
            </td>
          </template>
        ...
        <template v-if="this.leixing=='0'">
          ...
          <tr>
            ...
            <td>
              <el-select v-model.trim="fo.changePort"
                         clearable
                         @change="changePort"
                         size="small"
                         style="width:100%;"
                         placeholder="请选择">
                <el-option v-for="item in portOption"
                           :key="item.value"
                           :label="item.label"
                           :value="item.value">
                </el-option>
    ...
    <el-dialog :title="title"
      ...
      <el-form ref="fo"
        ...
        <el-form-item label="中文名字"
                      prop="nameCh">
          <el-input v-model.trim="fo.nameCh"
                    placeholder="请输入中文名字" />
        </el-form-item>
        <el-form-item label="英文名字"
                      prop="nameEn">
          <el-input v-model.trim="fo.nameEn"
                    placeholder="请输入英文名字" />
        </el-form-item>
      ...
      <div slot="footer"
           class="dialog-footer">
        <el-button type="primary"
                   @click="submitForm1">确 定</el-button>
...
export default {
  ...
  //           } else {
  //             if (this.fo.currentLocation == '汉堡') {
  //               this.fo.stationOneDistance = 1031
  //               this.fo.stationTwoDistance = parseInt(this.fo.stationOneDistance) + 30;
  //             } else if (this.fo.currentLocation == '慕尼黑') {
  //               this.fo.stationOneDistance = 1403
  //               this.fo.stationTwoDistance = parseInt(this.fo.stationOneDistance) + 30;
  //             } else if (this.fo.currentLocation == '列日') {
  //               this.fo.stationOneDistance = 1252
  //               this.fo.stationTwoDistance = parseInt(this.fo.stationOneDistance) + 30;
  //             } else if (this.fo.currentLocation == '亨克') {
  //               this.fo.stationOneDistance = 1410
  //               this.fo.stationTwoDistance = parseInt(this.fo.stationOneDistance) + 30;
  //             } else {
  //               this.fo.stationOneDistance = ''
  //               this.fo.stationTwoDistance = ''
  //             }
  //             if (this.fo.stationThrName == '山口') {
  //               this.fo.stationThrDistance = parseInt(this.fo.stationTwoDistance) + 5484;
  //               this.fo.stationFouDistance = parseInt(this.fo.stationThrDistance) + 3669;              }
  //             else if (this.fo.stationThrName == '二连') {
  //               this.fo.stationThrDistance = parseInt(this.fo.stationTwoDistance) + 8020;
  //               this.fo.stationFouDistance = parseInt(this.fo.stationThrDistance) + 1403;              }
  //             else if (this.fo.stationThrName == '绥芬河') {
  //               this.fo.stationThrDistance = parseInt(this.fo.stationTwoDistance) + 10223;
  //               this.fo.stationFouDistance = parseInt(this.fo.stationThrDistance) + 2593;              }
  //             else if (this.fo.stationThrName == '霍尔果斯') {
  //               this.fo.stationThrDistance = parseInt(this.fo.stationTwoDistance) + 5406;
  //               this.fo.stationFouDistance = parseInt(this.fo.stationThrDistance) + 3883;              }
  //             else if (this.fo.stationThrName == '满洲里') {
  //               this.fo.stationThrDistance = parseInt(this.fo.stationTwoDistance) + 7809;
  //               this.fo.stationFouDistance = parseInt(this.fo.stationThrDistance) + 2704;              }
  //             else {
  //               this.fo.stationThrDistance = ""
  //               this.fo.stationFouDistance = ""
  //             }
  ...
  //             this.fo.stationOneDistance = '';
  //             this.fo.stationTwoDistance = '';
  //           } else if (this.newName == '河内') {
  //             this.fo.stationOneDistance = 170;
  //             this.fo.stationTwoDistance = parseInt(this.fo.stationOneDistance) + 2159;
  //           } else {
  //             this.fo.stationOneDistance = '';
  //             this.fo.stationTwoDistance = '';
  //           }
  ...
  //     handler (newName, oldName) {
  //       if (newName != oldName) {
  //         if ((this.fo.stationOneDistance == '' || this.fo.stationOneDistance == undefined) && (this.fo.stationThrDistance == undefined || this.stationThrDistance == '')) {
  //           this.fo.stationFouDistance = ''
  //         } else if (this.fo.stationThrDistance == undefined || this.stationThrDistance == '') {
  //           this.fo.stationFouDistance = ''
  //         } else {
  //           if (this.fo.stationThrName == '山口') {
  //             this.fo.stationThrDistance = parseInt(this.fo.stationTwoDistance) + 5484;
  ...
  methods: {
    ...
    currentLocation() {
      ...
      if (this.leixing == '0') {
        if (this.fo.currentLocation == '') {
          ...
          if (this.fo.currentLocation == '汉堡') {
            this.fo.stationOneDistance = 1031
            this.fo.stationTwoDistance =
              parseInt(this.fo.stationOneDistance) + 30
          } else if (this.fo.currentLocation == '慕尼黑') {
            this.fo.stationOneDistance = 1403
            this.fo.stationTwoDistance =
              parseInt(this.fo.stationOneDistance) + 30
          ...
          if (this.fo.stationThrName == '山口') {
            this.fo.stationThrDistance =
              parseInt(this.fo.stationTwoDistance) + 5484
            this.fo.stationFouDistance =
              parseInt(this.fo.stationThrDistance) + 3669
          } else if (this.fo.stationThrName == '二连') {
            this.fo.stationThrDistance =
              parseInt(this.fo.stationTwoDistance) + 8020
            this.fo.stationFouDistance =
              parseInt(this.fo.stationThrDistance) + 1403
          } else if (this.fo.stationThrName == '绥芬河') {
            this.fo.stationThrDistance =
              parseInt(this.fo.stationTwoDistance) + 10223
            this.fo.stationFouDistance =
              parseInt(this.fo.stationThrDistance) + 2593
          } else if (this.fo.stationThrName == '霍尔果斯') {
            this.fo.stationThrDistance =
              parseInt(this.fo.stationTwoDistance) + 5406
            this.fo.stationFouDistance =
              parseInt(this.fo.stationThrDistance) + 3883
          } else if (this.fo.stationThrName == '满洲里') {
            this.fo.stationThrDistance =
              parseInt(this.fo.stationTwoDistance) + 7809
            this.fo.stationFouDistance =
              parseInt(this.fo.stationThrDistance) + 2704
          } else {
            this.fo.stationThrDistance = ''
            this.fo.stationFouDistance = ''
          }
      ...
      if (this.leixing == '3') {
        if (this.fo.currentLocation == '') {
          ...
          this.fo.stationOneDistance = 170
          this.fo.stationTwoDistance =
            parseInt(this.fo.stationOneDistance) + 2159
        } else {
          this.fo.stationOneDistance = this.fo.stationOneDistance
          this.fo.stationTwoDistance = this.fo.stationTwoDistance
        }
    ...
    stationThrName() {
      if (
        ...
        (this.fo.stationThrDistance == undefined ||
          this.stationThrDistance == '')
      ) {
        this.fo.stationFouDistance = ''
      } else if (
        this.fo.stationThrDistance == undefined ||
    ...
    handleRowClick(row, column, event) {
      if (this.selectID.indexOf(row.classId) == -1) {
        ...
        this.selectID.splice(
          this.selectID.findIndex(item => item == row.classId),
          1
        )
      }
    },
    ...
    handleAdd() {
      ...
      if (this.leixing == '0') {
        this.fo.stationOneName = '马拉'
        this.fo.stationTwoName = '布列斯特'
        this.fo.stationFouName = '郑州'
      }
    ...
    handleUpdat(row) {
      ...
      getTrain(id).then(response => {
        this.fo = JSON.parse(JSON.stringify(response.data))
        this.ope = true
        this.titl = '修改'
      })
      findClassDate(this.classId).then(response => {
