<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="90px">
            ...
            <el-form-item label="计划班列号" prop="classBh">
              <el-input
             ...
             <el-form-item label="往返" prop="classEastandwest">
                <el-select v-model.trim="queryParams.classEastandwest" placeholder="请选择" clearable>
            ...
            <el-form-item label="发运状态" prop="isRun">
              <el-select v-model.trim="queryParams.isRun" placeholder="请选择" clearable>
             ...
             <el-form-item label="发运日期" prop="actualClassDateValue">
              <!-- <el-date-picker
                v-model.trim="queryParams.actualClassDateValue"
                type="date"
                placeholder="-请选择-">
              </el-date-picker> -->
               <el-date-picker
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button v-hasPermi="['classOrder:dczorders:export0']" type="success" size="mini" icon="el-icon-download"  @click="handleExport0">下载模板</el-button>
      </el-col>
      ...
      <!-- <el-col :span="1.5">
        <el-button
          ...
          v-hasPermi="['classOrder:dczorders:applyCode']"
        >申请代码</el-button>
      </el-col> -->
    ...
    >
      ...
      <el-table-column label="发运日期" align="center" fixed="left" >
          <template slot-scope="scope">
            <span v-if="scope.row.actualClassDateValue">
              {{scope.row.actualClassDateValue.substring(0,10)}}
            </span> 
        </template>
      </el-table-column>
       ...
       <el-table-column label="修改记录" align="center" fixed="left" >
          <template slot-scope="scope">
            <span v-if="scope.row.classzynoRemark" @click="historyListFn(scope.row)" style="cursor:pointer;">
               点击查看
            </span> 
            <span v-else>
               暂无
      ...
      <el-table-column label="箱号校验" align="center">
         <template slot-scope="scope">
           {{scope.row.boxNumCheck}}
            <!-- <span v-if="scope.row.boxNumCheck === '0'">正确</span>
            <span v-else-if="scope.row.boxNumCheck === '1'">错误</span>
            <span v-else>-</span> -->
        </template>
      </el-table-column>
      ...
      <el-table-column label="运踪状态" align="center">
        <template slot-scope="scope">
          {{scope.row.trackState}}
            <!-- <span v-if="scope.row.trackState === '0'">在堆场</span>
            <span v-else-if="scope.row.trackState === '1'">已进站</span>
            <span v-else>-</span> -->
        </template>
      </el-table-column>
      ...
      <el-table-column label="公路部审核时间" align="center" prop="roadDate"  />
              ...
              <el-row>
                <el-col :span="20">
                  <el-form-item label="发运日期" >
                    <!-- <el-input v-model.trim="form.actualClassDateValue"  /> -->
                    <el-date-picker
    ...
    <el-dialog title="信息更新-列表" :visible.sync="open2" width="45%">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="this.open2=false">关 闭</el-button>
      </div>
