  ...
  <div class="app-container">
    <el-form :inline="true">
      <el-form-item label="菜单名称">
        <el-input v-model.trim="queryParams.menuName"
                  placeholder="请输入菜单名称"
                  clearable
                  size="small"
      ...
      <el-form-item label="状态">
        <el-select v-model.trim="queryParams.visible"
                   placeholder="菜单状态"
                   clearable
                   size="small">
          <el-option v-for="dict in visibleOptions"
                     :key="dict.dictValue"
    ...
    <el-dialog :title="title"
      ...
      <el-form ref="form"
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="根模块名称" prop="modelId">
              <el-select v-model.trim="form.modelId">
                <el-option label="维护中心"
                           value="0">维护中心</el-option>
                <el-option label="操作中心"
                           value="1">操作中心</el-option>
                <el-option label="系统管理"
                           value="2">系统管理</el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="24">
  ...
  data () {
    return {
      ...
      rules: {
        ...
        modelId: [
          { required: true, message: "根模块名称不能为空", trigger: "blur" }
        ]
      }
    };
  },
