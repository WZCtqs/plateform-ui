    ...
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
          ...
          <el-form-item label="推荐人" prop="referenceType">
           <el-select
           v-model.trim="queryParams.referenceType"
           clearable
           style="width:120px;"
           placeholder="请选择推荐人状态"
           >
           <el-option
           v-for="item in tjrStatus"
           :key="item.value"
           :value="item.value"
           :label="item.label"
           ></el-option>
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="推荐人邮箱" align="center" prop="referenceOtherMails" :show-overflow-tooltip="true"/>
          <el-table-column label="性别" align="center">
            <template slot-scope="scope">
              <span v-if="Number(scope.row.sex) === 0">男</span>
              <span v-else-if="Number(scope.row.sex) === 1">女</span>
              <!-- <span v-else-if="Number(scope.row.sex) === 2">未知</span> -->
              <span v-else></span>
            </template>
          </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="用户工号" prop="jobNumber">
              <el-input v-model.trim="form.jobNumber" placeholder="请输入用户工号" maxlength="50"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="12">
            <el-form-item label="用户账号" prop="userName">
              <el-input v-model.trim="form.userName" placeholder="请输入用户账号"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="推荐人状态" prop="referenceType">
              <el-radio v-model.trim="form.referenceType" label="0" :disabled="title==='修改用户管理'">否</el-radio>
              <el-radio v-model.trim="form.referenceType" label="1" :disabled="title==='修改用户管理'">是</el-radio>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.referenceType === '1'">
            <el-form-item label="推荐人邮箱" prop="referenceOtherMails">
              <el-input v-model.trim="form.referenceOtherMails" placeholder="请输入推荐人邮箱" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
<script>
    ...
    import {validatePhone, validateTelphone} from '@/api/validator'
        ...
        data() {
            return {
                ...
                rules: {
                    ...
                    referenceType: [
                        {required: true, message: "推荐人状态不能为空", trigger: "blur"}
                    ],
                    deptId: [
        ...
        methods: {
          ...
          this.loading = false;
            ...
            handleUpdate(row) {
                ...
                if(this.checkedRow[0].userName === 'admin'){
                    this.msgError("不允许操作超级管理员用户");
                }else {
                    this.reset();
                    this.getTreeselect();
