  ...
  <div class="app-container">
    <el-form :model="queryParams"
        ...
        <el-button type="success"
                   ...
                   size="mini"
                   @click="handleAdd"
                   v-hasPermi="['portalManage:requirement:add']">新增</el-button>
          <el-button
          type="success"
          icon="el-icon-edit"
          size="mini"
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['portalManage:requirement:edit']"
        >修改</el-button>
        <el-button type="danger"
                   ...
                   :disabled="multiple"
                   @click="handleDelete"
                   v-hasPermi="['portalManage:requirement:remove']">删除</el-button>
      </el-form-item>
    </el-form>
    ...
    <el-table v-loading="loading"
      ...
      <el-table-column label="类型"
        ...
        <template slot-scope="scope">
          ...
          <span v-else-if="scope.row.type==1">出口单证相关要求</span>
          <span v-else>铁路相关运单要求</span>
        </template>
      </el-table-column>
      <!-- <el-table-column label="中文内容" align="center" prop="content" show-overflow-tooltip>
      <template slot-scope="scope">
          <div v-html="scope.row.content"></div>
        </template>
      </el-table-column>  
      <el-table-column label="英文内容" align="center" prop="enContent" show-overflow-tooltip>
    <template slot-scope="scope">
...
<script>
import { listRequired, getRequired, delRequired, addRequired, updateRequired, exportRequired } from "@/api/portalManage/required";
