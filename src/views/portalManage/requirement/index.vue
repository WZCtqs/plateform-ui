      ...
      <el-form-item>
        <el-button type="success"
                   ...
                   <el-button size="mini"
                     ...
                     icon="el-icon-edit"
                     @click="handleUpdate"
                     v-hasPermi="['portalManage:requirement:edit']">修改</el-button>
...
<script>
import { listRequirement, getRequirement, delRequirement, addRequirement, updateRequirement, exportRequirement } from "@/api/portalManage/requirement";
