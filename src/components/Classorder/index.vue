  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="90px">
          ...
          <el-form-item label="是否委托ZIH提货" prop="shipOrderBinningway"  label-width="120px">
            <el-select v-model.trim="queryParams.shipOrderBinningway" placeholder="请选择" clearable size="small">
          ...
          <el-form-item label="托书状态" prop="isexamline" >
            <el-select v-model.trim="queryParams.isexamline" placeholder="请选择" clearable size="small">
              ...
              <el-option label="转待审核" value="3" />
              <el-option label="取消托书" value="4" />
              <el-option label="草稿" value="5" />
            </el-select>
          </el-form-item>
       
           <el-form-item label="修改状态" prop="changeType">
            <el-select v-model.trim="queryParams.changeType" placeholder="请选择" clearable size="small">
              <el-option label="-请选择-" value />
          ...
          <el-form-item label="整/拼箱" prop="isconsolidation" label-width="60px">
            <el-select v-model.trim="queryParams.isconsolidation" placeholder="请选择" clearable size="small">
              <el-option label="-请选择-" value />
           ...
           <el-form-item label="班列日期" prop="classDate" >
            ...
            <el-form-item label="方向" prop="classEastandwest" label-width="50px">
               <el-select @change="disabledStr='0'" v-model.trim="queryParams.classEastandwest" placeholder="请选择" clearable size="small" :disabled="disabledStr === '1' || disabledStr === '2'">
                <el-option label="-请选择-" value />
    ...
    >
      ...
      <el-table-column label="委托书编号" align="center" fixed="left">
      ...
      <el-table-column label="审核日期" align="center" prop="examDate" fixed="left" width="200" />
      ...
      <el-table-column label="修改记录" align="center" prop="isupdate">
       ...
       <el-table-column label="转待原因" align="center" prop="examInfo" />
    ...
    <el-dialog title="委托书信息更新列表" :visible.sync="isupdateListDialog" width="45%" :destroy-on-close="true">
       <ul v-for="(item,index) in isupdateList" :key="index" class="isupdateListULCss0">
...
<script>
import { fetchList2 as fetchList, detailapi, updateapi,orderCancelapi, deleteapi, orderListMy, downLoadExcel, getSiteByOrderId, orderCheckApplyapi, orderSpaceEditapi, historyEditRecord,addRemark,stationList,goodsInfo,addIsRead } from "@/api/classOrder/orders";
